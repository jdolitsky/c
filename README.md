...
| `12` `12.2` `12.2.1_git20220924-r9` `latest` | `sha256:1a23097b0ba6a1e2b2c3ae0e85cb04d848cf8ae7d101750ecb81aa6e0cac2797`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:1a23097b0ba6a1e2b2c3ae0e85cb04d848cf8ae7d101750ecb81aa6e0cac2797) | `386` `amd64` `arm64` `armv6` `armv7` `ppc64le` `riscv64` `s390x` |
